...
- `answer-discovery --feed-id ... --answers ...`
- `create-proposals --feed-id ...`
- `compare-proposals --request-id ...`
- `negotiate --proposal-id ... --instruction ... [--price-delta ...] [--seller-approved]`
- `sign --proposal-id ... [--human-approved]`
...
- `override --agent-id ... --action pause|resume|direct-instruction|cancel-negotiation|request-meeting|intervene`
