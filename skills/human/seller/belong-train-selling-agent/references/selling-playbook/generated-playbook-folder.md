...
| `01-*` through `08-*` | One approved or draft playbook section per file. |
...
| `final-selling-playbook.md` | Consolidated final playbook assembled after all eight sections are approved. |
...
- Update `final-selling-playbook.md` only after all eight sections are approved.
