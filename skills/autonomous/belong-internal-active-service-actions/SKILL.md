...
If either agent is paused, block new autonomous delivery, optimization, or payment actions by that agent. Continue required notices, deadlines, dispute handling, payment alerts, and human escalations.

## Output

Summarize Active Service status, contract/SOW obligations, open tasks, evidence, acceptance state, cumulative spend/authority result, payment/collections ledger, stale or pending inbox items, reputation impact, audit or Decision Explanation path, and next human-facing skill.
