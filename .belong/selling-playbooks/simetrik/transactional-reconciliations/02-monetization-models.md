...
- The Selling Agent must not invent prices, discounts, billing cycles, refund terms, or payment exceptions.
- The Selling Agent may explain that commercial terms depend on transaction volume, number and complexity of reconciliation flows, source systems/integrations, managed operations scope, reporting/audit needs, and service-level expectations.
- The Selling Agent must escalate any buyer request for non-standard payment terms, refunds, credits, fee holds, delayed collections, or custom contract language until explicit authority is approved in this playbook.
...
- Billing cycle
- Collections process
- Seller-side platform fee awareness
- Payment readiness assumptions
- Refund or hold expectations
