...
- `belong-run-buying-agent`: human-facing wrapper for asking the Buying Agent to continue autonomous work.
...
- `belong-run-selling-agent`: human-facing wrapper for asking the Selling Agent to continue autonomous work.
...
4. The human uses `belong-run-selling-agent` to let the Selling Agent continue: wait for or process discovery answers, send seller-signed Service Contract/SOW proposals, support negotiation, coordinate Active Service delivery, create Fulfillment Tasks, submit Deliverable Evidence Packages, manage collections behavior, and run Selling Optimization.
...
- Semantic search with optional tags: covered by Buying Request start/search runtime and buyer run flow.
- Engagement Feed, RFP-like competitive engagement, seller-led discovery: covered by buyer and seller run flows plus internal workflows.
...
- Active Service, deliverables, evidence, acceptance, messages, meetings, Change Orders, and fulfillment escalations: covered by shared Active Service checks, Inbox, seller run, buyer run, and internal Active Service actions.
...
- Provider Optimization, Selling Optimization, and Composite Buying Requests: covered by buyer/seller run skills, internal workflows, runtime commands, and tests.
...
- Added human-facing autonomous continuation wrappers: `belong-run-buying-agent` and `belong-run-selling-agent`.
